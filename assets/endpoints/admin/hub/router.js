...
//	USERS
	...
	router.put('/users',(req,res)=>{index.users.update(index,req.body,(p)=>{res.json(p)});});
	...
	router.put('/users/role/:user/:application',(req,res)=>{index.users.role.update(index,[req.params.user,req.params.application,req.body],(p)=>{res.json(p)});});
